...
namespace MauiApp1
{
    public partial class AppShell : Shell
    {
        ...
        public AppShell(AppController controller)
        {
            ...
            Routing.RegisterRoute(nameof(StudentProfileRegistrationPage), typeof(StudentProfileRegistrationPage));
            Routing.RegisterRoute(nameof(VnPayPaymentPage), typeof(VnPayPaymentPage));
            Routing.RegisterRoute(nameof(PaymentResultPage), typeof(PaymentResultPage));
        }
    }
}
