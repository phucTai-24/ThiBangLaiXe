...
-- Chay bang tai khoan sysadmin (vd: sa) tren SQL Server instance localhost
-- =========================================================
...
BEGIN
    ...
    WITH PASSWORD = N'TblxApp@2026#ChangeMe',
         CHECK_POLICY = ON,
...
PRINT N'OK: Da tao login tblx_app + user + quyen trong DB he_thong_thi_bang_lai';
GO
-- ================================
-- 1. TAO DATABASE
-- ================================
...
GO-- Seed data for Admin account
...
USING (VALUES 
    ...
    ('USER', N'Người dùng thường', N'Tài khoản học viên')
