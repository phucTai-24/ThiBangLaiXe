...
public class UpdateExamStructureRuleRequestValidator : AbstractValidator<UpdateExamStructureRuleRequestDto>
{
    public UpdateExamStructureRuleRequestValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
            .MaximumLength(150);
